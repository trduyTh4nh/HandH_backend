...
class CartController {
    ...
    addProductToCart = async (req: Request, res: Response, next: NextFunction) => {
        ...
        new SuccessResponse({
            ...
            metadata: await CartService.addProductIntoCart(idProduct, idCart, sizeProduct, colorProduct)
        }).send(res)
    }

    removeProductInCart = async (req: Request, res: Response, next: NextFunction) => {
    ...
    decreaseQuantity = async (req: Request, res: Response, next: NextFunction) => {
        ...
        new SuccessResponse({
            ...
            metadata: await CartService.decreaseQuantityProductInCart(idCartDetail, idCart)
        }).send(res)
    }
